...
class BasicAnalyticsTest {
    ...
    void getCategories() {
        ...
        Wheel winter = new Wheel("2", "hakkapelita", "summer", "A", 5);
    ...
    void getAggregationByCategoryAndPlace() {
        Wheel wheel = new Wheel("1", "hakkapelita", "summer", "A", 5);
        Wheel winter = new Wheel("2", "hakkapelita", "summer", "A", 5);
        Wheel winter2 = new Wheel("3", "hakkapelita", "summer", "A", 5);
        Wheel winter3 = new Wheel("4", "hakkapelita", "summer", "A", 5);
        Wheel allSeasons = new Wheel("5", "hakkapelita", "summer", "A", 5);
        storage.putAllItems(List.of(wheel, winter, winter2, winter3, allSeasons));
    ...
    void getAggregationByCategoryAndPlaceSingleRequest() {
        Wheel wheel = new Wheel("1", "hakkapelita", "winter", "A", 5);
